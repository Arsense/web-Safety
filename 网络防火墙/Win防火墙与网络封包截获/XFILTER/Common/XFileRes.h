...
#define MAX_NET_MESSAGE_LENTH			\
	MAX_NET_COMMAND_LENTH - MAX_NET_COMMAND_VERSION_LENTH - 2
...
#define	REG_AUTO_START_KEY			\
	_T("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run")
#define REG_AUTO_START_ITEM			_T("XFILTER")
#define	REG_PROTOCOL_CATALOG_KEY	\
...
#define	REG_INSTALL_KEY				\
	_T("SYSTEM\\CurrentControlSet\\Services\\WinSock2\\XSTUDIO_TCPIPDOG")
...
#define XFILTER_PRODUCT_ID			0xAA03
...
#define ACL_HEADER_SERIAL			0xAA03
...
#define ACL_HEADER_COMMAND_URL		\
	_T("http://www.xfilt.com/command_%s_%u_%u_%u.txt\0")
#define ACL_HEADER_REGISTER_URL		\
	_T("http://www.xfilt.com/xfilter_register_user.asp\0")
