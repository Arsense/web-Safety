========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : NetTrafficButton
========================================================================


Diese NetTrafficButton-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre NetTrafficButton-Anwendung bilden.
...
NetTrafficButton.h
	...
	Anwendungsklasse CNetTrafficButtonApp.
...
res\NetTrafficButton.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei NetTrafficButton.rc eingebunden.

res\NetTrafficButton.rc2
...
NetTrafficButtonDlg.h, NetTrafficButtonDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CNetTrafficButtonDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in NetTrafficButton.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	NetTrafficButton.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
