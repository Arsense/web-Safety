...
/* void Cls_OnEnterMenuLoop(HWND hwnd, HMENU hMenu) */
#define HANDLE_WM_ENTERMENULOOP(hwnd, wParam, lParam, fn) \
    ((fn)((hwnd), (HMENU)(wParam)), 0L)
#define FORWARD_WM_ENTERMENULOOP(hwnd, hMenu, fn) \
    (void)(fn)((hwnd), WM_ENTERMENULOOP, (WPARAM)(HMENU)(hMenu), 0L)

/* void Cls_OnExitMenuLoop(HWND hwnd, HMENU hMenu) */
#define HANDLE_WM_EXITMENULOOP(hwnd, wParam, lParam, fn) \
    ((fn)((hwnd), (HMENU)(wParam)), 0L)
#define FORWARD_WM_EXITMENULOOP(hwnd, hMenu, fn) \
    (void)(fn)((hwnd), WM_EXITMENULOOP, (WPARAM)(HMENU)(hMenu), 0L)
...
// Added By Andy (SPR) 06-18-1998
#define Control_SetFont(hwndCtl,hFont,fRedraw)		((void)SendMessage((hwndCtl), WM_SETFONT, (WPARAM)(hFont), MAKELPARAM((fRedraw),0)))
#define Control_SetText(hwndCtl,lpsz)               ((int)SendMessage((hwndCtl), WM_SETTEXT, (WPARAM)(0),(LPARAM)(LPCTSTR)(lpsz)))
#define Control_GetText(hwndCtl,lpsz,cchTextMax)    ((int)SendMessage((hwndCtl), WM_GETTEXT, (WPARAM)(cchTextMax),(LPARAM)(lpsz)))
